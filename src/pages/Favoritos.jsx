  ...
  return (
    <div className="min-h-screen bg-vibe-gradient text-white relative">
      ...
      <div className="pt-28 px-8 pb-16">
        <h1 className="text-4xl font-extrabold mb-10 text-center">Favoritos</h1>
        {loading ? (
          <div className="text-center opacity-80">A carregar favoritos...</div>
        ) : events.length === 0 ? (
           <div className="text-center opacity-80">Ainda não tens eventos favoritos.</div>
        ) : (
